-- Clean up existing demo accounts to ensure fresh password hash seed
...
VALUES (1, 'Metformin 500mg', 'ABC Pharma', 'Metformin', '500mg', 'Diabetes', 100.00, 0, 1, 'First-line medication for the treatment of type 2 diabetes.', 'ABC Pharmaceuticals', ADD_MONTHS(CURRENT_TIMESTAMP, 24), 1);

-- ID 2: Metformin 500mg - XYZ Pharma (IN STOCK Alternative 1)
INSERT INTO medicines (id, medicine_name, brand_name, composition, strength, category, price, stock_quantity, requires_prescription, description, manufacturer, expiry_date, active)
VALUES (2, 'Metformin 500mg', 'XYZ Pharma', 'Metformin', '500mg', 'Diabetes', 80.00, 50, 1, 'Metformin hydrochloride 500mg sustained release formulation.', 'XYZ Healthcare', ADD_MONTHS(CURRENT_TIMESTAMP, 18), 1);

-- ID 3: Metformin 500mg - PQR Pharma (IN STOCK Alternative 2)
INSERT INTO medicines (id, medicine_name, brand_name, composition, strength, category, price, stock_quantity, requires_prescription, description, manufacturer, expiry_date, active)
VALUES (3, 'Metformin 500mg', 'PQR Pharma', 'Metformin', '500mg', 'Diabetes', 75.00, 25, 1, 'Metformin hydrochloride tablets 500mg.', 'PQR Labs', ADD_MONTHS(CURRENT_TIMESTAMP, 20), 1);

-- ID 4: Metformin 1000mg - ABC Pharma (DIFFERENT STRENGTH - Should NOT match as 500mg alternative)
INSERT INTO medicines (id, medicine_name, brand_name, composition, strength, category, price, stock_quantity, requires_prescription, description, manufacturer, expiry_date, active)
VALUES (4, 'Metformin 1000mg', 'ABC Pharma', 'Metformin', '1000mg', 'Diabetes', 140.00, 40, 1, 'Higher dosage metformin 1000mg formulation.', 'ABC Pharmaceuticals', ADD_MONTHS(CURRENT_TIMESTAMP, 24), 1);

-- ID 5: Amlodipine 5mg - ABC Pharma (IN STOCK)
INSERT INTO medicines (id, medicine_name, brand_name, composition, strength, category, price, stock_quantity, requires_prescription, description, manufacturer, expiry_date, active)
VALUES (5, 'Amlodipine 5mg', 'ABC Pharma', 'Amlodipine', '5mg', 'Cardiovascular', 50.00, 100, 1, 'Calcium channel blocker used to treat high blood pressure.', 'ABC Pharmaceuticals', ADD_MONTHS(CURRENT_TIMESTAMP, 12), 1);

-- ID 6: Amlodipine 5mg - Sun Pharma (IN STOCK Alternative)
INSERT INTO medicines (id, medicine_name, brand_name, composition, strength, category, price, stock_quantity, requires_prescription, description, manufacturer, expiry_date, active)
VALUES (6, 'Amlodipine 5mg', 'Sun Pharma', 'Amlodipine', '5mg', 'Cardiovascular', 45.00, 80, 1, 'Amlodipine besylate tablets 5mg.', 'Sun Pharma Industries', ADD_MONTHS(CURRENT_TIMESTAMP, 30), 1);

-- ID 7: Atorvastatin 10mg - Cipla (IN STOCK)
INSERT INTO medicines (id, medicine_name, brand_name, composition, strength, category, price, stock_quantity, requires_prescription, description, manufacturer, expiry_date, active)
VALUES (7, 'Atorvastatin 10mg', 'Cipla', 'Atorvastatin', '10mg', 'Cholesterol', 110.00, 60, 1, 'Statin medication used to prevent cardiovascular disease.', 'Cipla Ltd', ADD_MONTHS(CURRENT_TIMESTAMP, 15), 1);
